...
# save figure
ggsave("figures/la_wastewater_discharge_map.png", map1, width = 8, height = 6, units = "in")
...
plot1 <- ggplot(data = birds_redlining_summary) +
  ...
  geom_text(aes(x = grade, y = perc, label = round(as.numeric(perc))),vjust = -0.5)+
  scale_fill_manual(values = c("#9C964A", "#F3DF6C", "#DC863B", "#C93312"))+
  labs(y = "Percent of Total Observations (%)", x = "HOLC Grade", title = "Percent of Bird Observations in 2022 by HOLC Grade Category", fill = "HOLC Grade")+
  theme_minimal()
